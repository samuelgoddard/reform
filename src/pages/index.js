...
import { fade, fadeHomeImage } from "../helpers/transitionHelper"
                        ...
                        <g id="logo-stroke" clipPath="url(#clip-logo-stroke)">
                          ...
                          <g id="Group_107" data-name="Group 107" transform="translate(-33 0)">
                            ...
                            <motion.path
                              ...
                              transition={{ duration: 1.25, ease: [0.76, 0, 0.24, 1] }}  d="M0,.48H90.409c44.03,0,73.384,23.678,73.384,63.257,0,32.142-15.264,49.9-39.872,56.114v.587c49.51,9.784,31.457,97.258,43,100.976v1.761H136.983c-9.784-9.344,11.5-90.066-44.911-90.066H28.033v90.066H0ZM28.033,108.109H83.853c23.042,0,52.053-2.789,52.053-41.437S106.9,25.43,83.853,25.43H28.033Z" fill="#333" />

                            {/* E */}
                            <motion.path
                              initial={{ translateY: 500.666, translateX: 182.501 }}
                              animate={{ translateY: 0 }}
                              transition={{ duration: 1.25, delay: 0.15, ease: [0.76, 0, 0.24, 1] }}  d="M180.872,95.536v24.9H66.492V198.42H199.561v24.755H38.41V.48H195.842V25.43H66.492V95.536Z" fill="#333" />

                            {/* F */}
                            <motion.path
                              initial={{ translateY: 500.666, translateX: 329.316 }}
                              animate={{ translateY: 0 }}
                              transition={{ duration: 1.25, delay: 0.30, ease: [0.76, 0, 0.24, 1] }}  d="M203.573,97.738v24.95h-99.41V223.175H76.13V.48H227.154V25.43H104.163V97.738Z" fill="#333" />  

                            {/* O FILLED */}
                            <motion.path
                              initial={{ translateY: 500.666, translateX: 437.674 }}
                              animate={{ translateY: 0 }}
                              transition={{ duration: 1.25, delay: 0.45, ease: [0.76, 0, 0.24, 1] }}
                            ...
                            <motion.path
                              ...
                              animate={{ translateY: 0 }}
                              transition={{ duration: 1.25, delay: 0.60, ease: [0.76, 0, 0.24, 1] }} d="M147.48.48h90.6c44.03,0,73.384,23.678,73.384,63.257,0,32.142-15.313,49.9-39.921,56.114v.587c49.558,9.784,31.506,97.258,43,100.976v1.761H284.316c-9.785-9.344,11.546-90.066-44.862-90.066H175.513v90.066H147.48Zm28.033,107.629h55.772c23.091,0,52.053-2.789,52.053-41.437s-28.962-41.437-52.053-41.437H175.513Z" fill="#333"></motion.path>
                            
                            {/* M */}
                            <motion.path
                              initial={{ translateY: 500.666, translateX: 756.529 }}
                              animate={{ translateY: 0 }}
                              transition={{ duration: 1.25, delay: 0.75, ease: [0.76, 0, 0.24, 1] }}  d="M185.89.48h38.355L294.058,185.6h.587L364.457.48h38.355v222.7H374.78V40.058h-.636L306.826,223.175h-24.95L214.559,40.058h-.636V223.175H185.89Z" fill="#333"/>
                          </g>
                        </g>
                      </svg>
                </div>
