                          ...
                          <g id="logo-stroke" clipPath="url(#clip-logo-stroke)">
                            ...
                            <g id="Group_107" data-name="Group 107" transform="translate(-33 0)">
                              ...
                              <motion.path
                                ...
                                animate={{ translateY: 0 }}
                                transition={{ duration: 1.5, ease: [0.76, 0, 0.24, 1] }}  d="M180.872,95.536v24.9H66.492V198.42H199.561v24.755H38.41V.48H195.842V25.43H66.492V95.536Z" fill="#333" />

                              {/* F */}
                              <motion.path
                                initial={{ translateY: 500.666, translateX: 329.316 }}
                                animate={{ translateY: 0 }}
                                transition={{ duration: 1.5, ease: [0.76, 0, 0.24, 1] }}  d="M203.573,97.738v24.95h-99.41V223.175H76.13V.48H227.154V25.43H104.163V97.738Z" fill="#333" />  
                              ...
                              <motion.path
                                ...
                                animate={{ translateY: 0 }}
                                transition={{ duration: 1.5, ease: [0.76, 0, 0.24, 1] }} d="M147.48.48h90.6c44.03,0,73.384,23.678,73.384,63.257,0,32.142-15.313,49.9-39.921,56.114v.587c49.558,9.784,31.506,97.258,43,100.976v1.761H284.316c-9.785-9.344,11.546-90.066-44.862-90.066H175.513v90.066H147.48Zm28.033,107.629h55.772c23.091,0,52.053-2.789,52.053-41.437s-28.962-41.437-52.053-41.437H175.513Z" fill="#333"></motion.path>
                              
                              {/* M */}
                              <motion.path
                                initial={{ translateY: 500.666, translateX: 756.529 }}
                                animate={{ translateY: 0 }}
                                transition={{ duration: 1.5, ease: [0.76, 0, 0.24, 1] }}  d="M185.89.48h38.355L294.058,185.6h.587L364.457.48h38.355v222.7H374.78V40.058h-.636L306.826,223.175h-24.95L214.559,40.058h-.636V223.175H185.89Z" fill="#333"/>
                            </g>
                          </g>
                        </svg>
                  </div>
              ...
              <motion.div variants={fade} className="mt-5 md:-mt-4 xl:-mt-8 border-b border-black relative z-0">
                <div className="pb-12 md:pb-20 3xl:pb-32 bg-offwhitelight">
                  <div className="relative lg:-mt-12">
                    ...
                    <Img fluid={ this.props.data.home.image.fluid } className="w-full home-image bg-offwhitelight will-change" />
                  </div>
                  ...
                  <div className="flex flex-wrap">
                    ...
                    <div className="w-full md:max-w-lg xl:max-w-2xl 3xl:max-w-4xl text-right ml-auto -mt-6 md:-mt-48 xl:-mt-84 3xl:-mt-96 px-5 md:pr-8 xl:pr-12 flex flex-wrap">
                      ...
                      <div className="scrollreveal block 2xl:hidden">
                        <h2 className="text-3xl md:text-4xl xl:text-5xl 3xl:text-6xl relative z-10 w-full block 3xl:pl-16 textrevealnonescrollContent text-right" dangerouslySetInnerHTML={{ __html:this.props.data.home.heroText }}></h2>
                      </div>

                      <div className="scrollreveal hidden 2xl:block">
                        <h2 className="text-3xl md:text-4xl xl:text-5xl 3xl:text-6xl relative z-10 w-full block 3xl:pl-16 textrevealContent text-right" dangerouslySetInnerHTML={{ __html:this.props.data.home.heroText }}></h2>
                      </div>
                    </div>
                  </div>
                </div>

                <div  className="flex flex-wrap pb-8 md:pb-16 xl:pb-20 px-5 md:px-12 lg:px-16 xl:px-20 scrollreveal">
                  ...
                  <div className="w-1/2 text-right textreveal">
