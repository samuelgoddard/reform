    ...
    <>
      ...
      <div className="h-screen flex flex-wrap flex-col">
        <motion.section
          ...
          exit="exit"
        >
          <div className="flex flex-wrap pt-16 md:pt-16 xl:pt-20 pr-5 md:pr-8 relative h-full items-end justify-end">
            ...
            <h1 className="absolute top-0 left-0 text-xl md:text-2xl mt-16 md:mt-20 xl:mt-24 ml-4 xl:ml-8 max-w-xs leading-tighter pt-2 xl:pt-4">
              Sorry that page does not exist, please navigate back to our <Link className="underline" to="/">home page here.</Link>
            </h1>
          </div>
        </motion.section>
